...
const CalculatorScreen: React.FC = () => {
  ...
  // Replace the existing setRatio function with this version
  const setRatio = (
    meat: number,
    bone: number,
    organ: number,
    ...
    React.useCallback(() => {
      const loadRatios = async () => {
        try {
          ...
          const tempSelectedRatio = await AsyncStorage.getItem(
            "tempSelectedRatio"
          );
      ...
      loadRatios();
    }, [currentMeatWeight, currentBoneWeight, currentOrganWeight]) // Add weight dependencies to ensure correctors update
  );
  ...
  // Modify the setRatio function to not update the recipe's ratio immediately
  // Replace the existing setRatio function with this version
