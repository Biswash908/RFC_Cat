...
const SearchScreen = () => {
  ...
  const [ingredients, setIngredients] = useState([
    ...
    { id: '36', name: 'Lamb Arm', meat: 91, bone: 9, organ: 0 },
    { id: '37', name: 'Lamb Blade', meat: 72, bone: 28, organ: 0 },
    { id: '38', name: 'Lamb Centre Slice Leg', meat: 94, bone: 6, organ: 0 },
    { id: '39', name: 'Lamb Heart', meat: 100, bone: 0, organ: 0 },
    { id: '40', name: 'Lamb Kidney', meat: 0, bone: 0, organ: 100 },
    { id: '41', name: 'Lamb Loin', meat: 72, bone: 28, organ: 0 },
    { id: '42', name: 'Lamb Ribs', meat: 74, bone: 26, organ: 0 },
    { id: '43', name: 'Lamb Whole Shank', meat: 86, bone: 14, organ: 0 },
    { id: '44', name: 'Lamb Half Shank', meat: 83, bone: 17, organ: 0 },
    ...
    { id: '59', name: 'Pork Heart', meat: 100, bone: 0, organ: 0 },
    { id: '60', name: 'Pork Kidney', meat: 0, bone: 0, organ: 100 },
    { id: '61', name: 'Pork Liver', meat: 0, bone: 0, organ: 100 },
    { id: '62', name: 'Pork Loin steak', meat: 100, bone: 0, organ: 0 },
    { id: '63', name: 'Pork Ribs', meat: 70, bone: 30, organ: 0 },
    { id: '64', name: 'Pork Tails', meat: 70, bone: 30, organ: 0 },
    { id: '65', name: 'Powdered Eggshell', meat: 0, bone: 2500, organ: 0 },
    { id: '66', name: 'Quail Whole Oven Ready', meat: 73, bone: 27, organ: 0 },
    { id: '67', name: 'Rabbit Whole Rabbit (Dressed)', meat: 70, bone: 30, organ: 0 },
    { id: '68', name: 'Turkey Back', meat: 59, bone: 41, organ: 0 },
    { id: '69', name: 'Turkey Breast', meat: 90, bone: 10, organ: 0 },
    { id: '70', name: 'Turkey Drumstick', meat: 79, bone: 21, organ: 0 },
    { id: '71', name: 'Turkey Leg', meat: 83, bone: 17, organ: 0 },
    { id: '72', name: 'Turkey Neck', meat: 58, bone: 42, organ: 0 },
    { id: '73', name: 'Turkey Thigh', meat: 85, bone: 15, organ: 0 },
    { id: '74', name: 'Turkey Whole', meat: 61, bone: 39, organ: 0 },
    { id: '75', name: 'Turkey Wing', meat: 67, bone: 33, organ: 0 },
    { id: '76', name: 'Unbalanced Premade 50/12/35', meat: 50, bone: 12, organ: 35 },
    { id: '77', name: 'Unbalanced Premade 50/20/30', meat: 50, bone: 20, organ: 30 },
    { id: '78', name: 'Unbalanced Premade 75/5/20', meat: 75, bone: 5, organ: 20 },
    { id: '79', name: 'Unbalanced Premade 85/10/5', meat: 85, bone: 10, organ: 5 },
    { id: '80', name: 'Unbalanced Premade 94/3/3', meat: 94, bone: 3, organ: 3 },
    { id: '81', name: 'Veal Heart', meat: 100, bone: 0, organ: 0 },
    { id: '82', name: 'Veal Kidney', meat: 0, bone: 0, organ: 100 }
