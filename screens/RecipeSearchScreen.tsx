...
const RecipeSearchScreen = () => {
  ...
  const [ingredients, setIngredients] = useState([
    ...
    { id: '61', name: 'Powdered Eggshell', meat: 0, bone: 2500, organ: 0 },
  ...
  const { recipeId, recipeName } = route.params || {}; // Safely handle route params

  console.log('RecipeSearchScreen - Recipe Name:', recipeName, 'Recipe ID:', recipeId);
  ...
  const handlePressIngredient = (ingredient) => {
    navigation.navigate('RecipeFoodInfoScreen', {
    ingredient,
    editMode: false,
    recipeName,
    recipeId,
    ...
    >
      ...
      <View style={[styles.searchBarContainer, Platform.OS === 'android' && { marginBottom: 10 }]}>
        <TextInput
          ...
          value={searchQuery}
          onChangeText={text => setSearchQuery(text.trim())} // Trim input
        />
